...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">Manage Tugas</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">		  
		<form method="post" action="marksheet/fetchStudentMarksheet" class="form-horizontal" id="fetchStudentMarksheet">
		  	...
		  	<div class="form-group">
		    	<label for="marksheetName" class="col-sm-2 control-label">Tugas</label>
		    	<div class="col-sm-10">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="marksheetName">Nama Tugas</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <label for="editMarksheetName">Nama Tugas</label>
		  ...
		  <div class="form-group">
		    <label for="editDate">Tanggal Ujian: </label>		    
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeMarksheetModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-success" id="removeMarksheetBtn">Simpan</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
